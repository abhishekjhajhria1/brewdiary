...
export function Together() {
  ...
  return (
    <>
      ...
      {room === "feed" && (
        <>
          {/* The pegs/beers tally deliberately does NOT live on this open feed. It is a
              round counter for when you're actually together — so it appears only inside a
              party room (see PartyRoom's PartyTally), never on the solo Together landing. */}
