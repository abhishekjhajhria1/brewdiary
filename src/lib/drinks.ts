...
export const DRINKS: DrinkDef[] = [
  ...
  { canonical: "Amber Ale", family: "Pale Ale", type: "beer", aliases: ["red ale", "irish red"] },
  { canonical: "Saison", family: "Saison", type: "beer", aliases: ["farmhouse ale"] },
  // ── beer, by name (the bottles people actually order — India first, then global) ──
  // Each folds into a STYLE family so counts stay tidy; typing "kingfisher" still
  // suggests the brand, but it groups under Lager. Add freely — one line per label.
  { canonical: "Kingfisher", family: "Lager", type: "beer", aliases: ["kingfisher premium", "kingfisher strong", "kingfisher ultra", "kf"] },
  { canonical: "Bira 91 White", family: "Wheat Beer", type: "beer", aliases: ["bira white", "bira 91 wit"] },
  { canonical: "Bira 91 Blonde", family: "Lager", type: "beer", aliases: ["bira blonde"] },
  { canonical: "Bira 91 Boom", family: "Lager", type: "beer", aliases: ["bira boom"] },
  { canonical: "Bira 91 IPA", family: "IPA", type: "beer", aliases: ["bira ipa"] },
  { canonical: "Simba", family: "Wheat Beer", type: "beer", aliases: ["simba wit", "simba stout"] },
  { canonical: "Godfather", family: "Lager", type: "beer", aliases: ["the godfather"] },
  { canonical: "Haywards 5000", family: "Lager", type: "beer", aliases: ["haywards"] },
  { canonical: "Knock Out", family: "Lager", type: "beer" },
  { canonical: "Royal Challenge", family: "Lager", type: "beer" },
  { canonical: "Budweiser", family: "Lager", type: "beer", aliases: ["bud", "budweiser magnum"] },
  { canonical: "Heineken", family: "Lager", type: "beer" },
  { canonical: "Corona", family: "Lager", type: "beer", aliases: ["corona extra"] },
  { canonical: "Stella Artois", family: "Lager", type: "beer", aliases: ["stella"] },
  { canonical: "Carlsberg", family: "Lager", type: "beer" },
  { canonical: "Tuborg", family: "Lager", type: "beer" },
  { canonical: "Kronenbourg 1664", family: "Lager", type: "beer", aliases: ["kronenbourg", "1664", "1664 blanc"] },
  { canonical: "Peroni", family: "Lager", type: "beer" },
  { canonical: "Asahi", family: "Lager", type: "beer", aliases: ["asahi super dry"] },
  { canonical: "Hoegaarden", family: "Wheat Beer", type: "beer" },
  { canonical: "Erdinger", family: "Wheat Beer", type: "beer" },
  { canonical: "Paulaner", family: "Wheat Beer", type: "beer" },
  { canonical: "Bella Vita", family: "Lager", type: "beer" },
  { canonical: "White Rhino", family: "Wheat Beer", type: "beer" },
  { canonical: "Kati Patang", family: "Lager", type: "beer" },
